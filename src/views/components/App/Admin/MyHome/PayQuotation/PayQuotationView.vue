...
<script>	
import ItemsTable from '@/views/Components/App/Admin/MyHome/PayQuotation/PayQuotationOrderTable';
import PaymentSummary from '@/views/Components/App/Admin/MyHome/PayQuotation/PayQuotationSummary';
