                ...
                <v-layout row wrap>
                    <v-flex xs12>
                        ...
                        <v-layout row wrap>
                            ...
                            <v-flex xs12 >
                                <h5 class="font-weight-thin">Image</h5>
                            ...
                            <!----------------------------------SAMPLE ORDERS---------------------------------------------- -->
                                    ...
                                    <v-flex xs12 v-show="inquiry.sample_quantity">
                                        <h5 class="font-weight-thin">Sample Orders </h5>
                                        <h4 class="font-weight-bold">
                                        <span>Quantity: {{ inquiry.sample_quantity }} </span>
                                       </h4>
                                      ...
                                      <v-layout row wrap v-if="inquiry.attachments.length" class="attachments">
                                                ...
                                                <v-flex xs4 lg4 v-for="(attachment, index) in inquiryOEM" :key="attachment+'_'+index">
                                                       ...
                                                       <div v-else-if="attachment.filetype">
                                                         <a :href="attachment.location">
                                                             <v-icon style="font-size: 100px !important;padding: 10px;" color="red" large>fas fa-file-pdf</v-icon>
                                                         </a>
                                                       </div>
