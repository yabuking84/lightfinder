					...
					<v-card class="mb-2 pa-2" >
			   	 	   <v-layout row wrap pa-0>
							...
							<!-- section image -->
								...
								<img class="pa-0" width="138px;" :src="img">
			   	 	     	</v-flex>
							<!-- section image -->
							...
							<!-- section list -->
			   	 	     	<v-flex xs9 pl-5 pr-5>
		   	 	     			<h2 class="">{{ item.supplier_name }}</h2>
<!-- 		   	 	     			<h5 class="font-weight-light">{{ item.supplier_name }}</h5>
 -->		   	 	     			<v-spacer></v-spacer>
		   	 	     			 <h5 class="font-weight-light mb-1"> {{ dummy }} </h5>	  
			   	 	     	</v-flex>
			   	 	     	<!-- section list -->
							  ...
							  <v-flex xs2 mt-4>
						  		<v-layout align-end justify-end row column>
						  			<v-layout justify-end align-end row pa-0 mr-1>
										<v-chip color="green" text-color="white">{{ item.supplier_status }}</v-chip>
							 		</v-layout>
							 		<v-layout justify-end align-end row pa-0 mr-3 >
			   	 	   ...
			   	 	   <v-layout row wrap justify-end pl-2 pr-2 pb-2>
			   	 	     		<v-btn flat value="left"  class="v-btn--active light-green">
