             ...
             <v-flex xs6 class="pl-5 mt-5">
                ...
                <div class="mt-5 px-5"> 
                    ...
                    <div mt-3>
                      ...
                      <h4 class="white--text font-weight-light" >The Seller who can be manufacturers and distributors are required to register on the BUY ANY LIGHT platform</h4>
                    </div>

                    <div mt-4>
                      <h1 class="white--text">Suppliers</h1>
