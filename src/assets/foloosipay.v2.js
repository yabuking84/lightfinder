function Foloosipay(options) {
    var reference_token = options.reference_token
	var merchant_key = options.merchant_key
	...
	var FoloosiClose = { close: function(){
    ...
    // added by rene
    return document.getElementsByClassName('foloosi_wrapper');
}
